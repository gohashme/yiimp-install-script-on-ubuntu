...
output ""
    ...
    clear 
    output "If you found this helpful, please donate to BTC Donation: 18YRsrbA4WKVaqSYEQ8HDNyizxyh8Wp9yn"
    output ""
...
' | sudo -E tee /etc/nginx/blockuseragents.rules >/dev/null 2>&1
    ...
    cd ~
    git clone https://github.com/gohashme/yiimp.git
...
' | sudo -E tee /etc/yiimp/keys.php >/dev/null 2>&1
    ...
    output ""
    output "BTC Donation: 18YRsrbA4WKVaqSYEQ8HDNyizxyh8Wp9yn"
    output ""
...
output ""
output "If you found this script helpful please consider donating some BTC Donation: 18YRsrbA4WKVaqSYEQ8HDNyizxyh8Wp9yn "
